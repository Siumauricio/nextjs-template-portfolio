...
const ProjectsData = [
   ...
   {
      title: 'Maze Rat Game',
      description: 'Maze rat solver using PRIMS, Backtracking and DFS algorithm to find the shortest path to the exit, built with React and Bootstrap.',
      image: '/Maze-Rat.png',
   ...
   {
      title: 'Heroes App',
      description: 'Heroes App to display the Marvel API data, built with React and Bootstrap.',
   ...
   },
   {
      ...
      description: 'Simple Gif Generator App, built with React and Bootstrap.',
      image: '/Gif-App.png',
