...
import {SiDotnet, SiJavascript, SiNodedotjs, SiPostgresql, SiTailwindcss, SiVuedotjs} from 'react-icons/si/index';
...
export const Skills = () => {
   return (
      <section className="bg-base-200 pb-14 flex  items-center flex-col pt-5 border-b border-base-300" id="Skills">
         ...
         <div className="flex max-w-2xl bg-base-300 h-96 rounded-2xl shadow-lg shadow-base-100">
            {/* <div className="w-[4324px] bg-error">  <DiCss3 className="w-12 h-12 "color="699bf7" />
                        <span className="self-center">CSS</span></div> */}
            <div className="grid grid-cols-1 w-96  self-center px-32">
            ...
            <div className="grid grid-cols-1 w-96  self-center px-10">
               <div className="flex  flex-col w-full">
